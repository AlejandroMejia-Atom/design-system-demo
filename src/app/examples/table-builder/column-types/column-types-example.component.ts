...
const meta = tableBuilderExampleById('column-types');

@Component({
  selector: 'app-column-types-example',
...
export class ColumnTypesExampleComponent {
  protected readonly meta = meta;
  protected readonly data = PRODUCT_DATA;
  protected readonly columns = COLUMN_TYPE_COLUMNS;
